...
We provide a set of Book templates in this companion website to help you apply {method} and organize your requirements.
...
. https://github.com/FormalRequirements/requirements-handbook-companion/blob/main/templates/docx[DOCX]
. https://docs.google.com/document/d/1hNATn8pcanNqjJmwZFfEgFheAOwlw2X9iqza31TEFts/edit?usp=sharing[Google Doc]
. https://github.com/FormalRequirements/requirements-handbook-companion/blob/main/templates/latex[LaTeX]
. link:githubImpl.adoc[GitHub] 
. . https://github.com/FormalRequirements/requirements-handbook-companion/blob/main/templates/asciidoc[Asciidoc]
. SysML
...
(or leave {Handbook} page 32 refs)...
