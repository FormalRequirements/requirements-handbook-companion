...
//-------------------------------------
== Overview of the method image:pegs.svg[width=10%,pdfwidth=80%]
...
Advice would be to start with critical parts after maybe a little GUI step.
